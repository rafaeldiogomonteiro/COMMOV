...
As seguintes figuras ilustram os principais ecrãs da aplicação Velotask. Substituir os ficheiros na pasta \texttt{figures/} pelas capturas reais antes da entrega final.

\begin{figure}[H]
    \centering
    \begin{subfigure}{0.45\textwidth}
        \centering
        \captura[width=\textwidth]{figures/ecra_intro.png}
        \caption{Intro/onboarding}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\textwidth}
        \centering
        \captura[width=\textwidth]{figures/ecra_login.png}
        \caption{Início de sessão}
    \end{subfigure}
    \caption{Ecrãs iniciais da aplicação}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.45\textwidth}
        \centering
        \captura[width=\textwidth]{figures/ecra_dashboard.png}
        \caption{Dashboard}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\textwidth}
        \centering
        \captura[width=\textwidth]{figures/ecra_projetos.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.45\textwidth}
        \centering
        \captura[width=\textwidth]{figures/ecra_tarefa.png}
        \caption{Detalhe de tarefa}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\textwidth}
        \centering
        \captura[width=\textwidth]{figures/ecra_admin.png}
        \caption{Administração de utilizadores}
    \end{subfigure}
    \caption{Gestão operacional}
\end{figure}

\begin{figure}[H]
    \centering
    \captura[width=0.45\textwidth]{figures/ecra_estatisticas.png}
    \caption{Exportação de estatísticas em PDF}
\end{figure}
